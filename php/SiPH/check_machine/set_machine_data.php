...
if (isset($_POST['id']) && isset($_POST['machineID']) && isset($_POST['userID']) && isset($_POST['isResult'])) {
    ...
    if($p_DB == 0){
        function getImgPath($conn){
            $B_ID = $_POST['B_ID'];
            $img_path = "";
            $strSQL = "SELECT MD_ImagePath FROM configuration WHERE B_ID = $B_ID";
        ...
        if ($firstTime) { // Create new row
            ...
            $Sql = "INSERT INTO sterilemachine_check(CreateDate, MachineID, IsResult, Remark, UserCreate, B_ID) 
                    VALUES (NOW(), $machineID, $isResult, '$note', $userID, $B_ID)";
        ...
        if ($firstTime) { // Create new row
            ...
            $Sql = "INSERT INTO sterilemachine_check(CreateDate, MachineID, IsResult, Remark, UserCreate, B_ID) VALUES (GETDATE(), $machineID, $isResult, '$note', $userID, $B_ID)";
