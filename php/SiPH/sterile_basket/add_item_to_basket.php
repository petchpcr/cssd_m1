...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	while ($Result = $meQuery->fetch(PDO::FETCH_ASSOC)){
		...
		$Sql_check = "SELECT * FROM itemstockdetailbasket WHERE ItemStockID = '$ItemStockID' AND IsActive = 1 AND B_ID = $B_ID";
		...
		if($j==0){
			...
			if($basket_id != "-"){
				$Sql_in = "	INSERT INTO itemstockdetailbasket (BasketID, ItemStockID, WashDetailID, PairTime,IsActive, B_ID) 
							VALUES($basket_id, '$ItemStockID', '$w_id', $date, 1, $B_ID) 
							";
