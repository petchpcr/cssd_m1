...
$SqlUpdateSterile="UPDATE sterile SET SterileRoundNumber ='$SterileRoundNumber' WHERE sterile.DocNo='$docno' AND sterile.B_ID = $B_ID";

$SqlUpdateBach="UPDATE batch SET MachineRound ='$SterileRoundNumber' WHERE batch.DocNo='$docno' AND batch.B_ID = $B_ID";
