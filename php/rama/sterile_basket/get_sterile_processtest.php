...
if($_SERVER['REQUEST_METHOD']=='POST' && $_POST['pro_id']!=null){
	...
	$B_ID = $_POST["B_ID"];
	$WHERE_B_ID = "";
	$steriletype_machine_B_ID = "";
	$sterilemachineprogram_B_ID = "";	
	$sterilemachinedetail_B_ID = "";
	if($B_ID != "0"){
		$WHERE_B_ID = " WHERE B_ID = $B_ID";
		$steriletype_machine_B_ID = " AND steriletype_machine.B_ID = $B_ID";
		$sterilemachineprogram_B_ID = " AND sterilemachineprogram.B_ID = $B_ID";
		$sterilemachinedetail_B_ID = " AND sterilemachinedetail.B_ID = $B_ID";
	}

	$SR_IsUsedSterileType = 0;
	$SR_IsUsedMachinePairProcess = 0;
	$Sql_con = "SELECT SR_IsUsedSterileType,SR_IsUsedMachinePairProcess FROM configuration $WHERE_B_ID";
