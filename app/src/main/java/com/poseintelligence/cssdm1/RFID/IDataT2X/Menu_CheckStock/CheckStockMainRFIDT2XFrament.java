...
public class CheckStockMainRFIDT2XFrament extends RFIDT2XFrament {
    private HTTPConnect httpConnect = new HTTPConnect();

    private RFIDMapToPay itemCheckAdapter, itemCantCheckAdapter;
    ...
    protected void initView(final View v) {
        ...
        txtHeadRFIDCount1.setText("พบในสต๊อก : ");
        txtHeadRFIDCount2.setText("ไม่พบในสต๊อก : ");
        txtHeadRFIDCount1.setVisibility(View.GONE);
        txtHeadRFIDCount2.setVisibility(View.GONE);

        itemCheckAdapter = new RFIDMapToPay(getActivity(), itemList1);
        listView_item_rfid1.setAdapter(itemCheckAdapter);

        itemCantCheckAdapter = new RFIDMapToPay(getActivity(), itemList2);
        listView_item_rfid2.setAdapter(itemCantCheckAdapter);

        itemCheckAdapter.registerDataSetObserver(new DataSetObserver() {
            @Override
        ...
        itemCantCheckAdapter.registerDataSetObserver(new DataSetObserver() {
            @Override
            public void onChanged() {
    ...
    protected void clearData(){
        super.clearData();
        itemCheckAdapter.notifyDataSetChanged();
        itemCantCheckAdapter.notifyDataSetChanged();
    }
    ...
    public void map_rfid(String rfidList){

        class map_rfid extends AsyncTask<String, Void, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    result = httpConnect.sendPostRequest(getUrl + "rfid_scanner/check_stock/map_rfid_select_stock.php", data);
                } catch (Exception e) {
