...
public class ModelPayoutDetailSignature {
    String  ID,
            itemcode,
            itemname,
            ItemStockID,
    ...
    public ModelPayoutDetailSignature(String ID, String itemcode, String itemname, String itemStockID, String usageCode, String pay_Qty, String stock_Qty, String qty, String balance, String refDocNo, String Program, String IsReceiveNotSterile, String Printno, String UserPayID, int index) {
        this.ID = ID;
