...
public class ModelPayoutDetailo {
    String  ID,
            itemcode,
            itemname,
            ItemStockID,
    ...
    public ModelPayoutDetailo(String ID, String itemcode, String itemname, String itemStockID, String usageCode, String pay_Qty, String stock_Qty, String qty, String balance, String refDocNo, String Program, int index) {
        this.ID = ID;
