...
public class ListPayoutDetailItemOAdapter extends ArrayAdapter<ModelPayoutDetailo> {

    private final List<ModelPayoutDetailo> DATA_MODEL;
    private final Activity context;

    public ListPayoutDetailItemOAdapter(Activity context, List<ModelPayoutDetailo> DATA_MODEL) {
